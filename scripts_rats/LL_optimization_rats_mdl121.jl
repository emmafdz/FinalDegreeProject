...
if rat_num in rats_half # rates amb trials de 10 frames
    Nstim_train = trunc(Int,n_stim_10)
    stim_train = stim_10[20001:20000+Nstim_train,:]
    choices_train = choices_10[20001:20000+Nstim_train,:]
...
if rat_num in rats_sec # rates amb trials de 20 frames
    Nstim_train = trunc(Int,n_stim_20)
    stim_train = stim_20[20001:20000+Nstim_train,:]
    choices_train = choices_20[20001:20000+Nstim_train,:]
    history_bias=zeros(Nstim_train)
    Tframe = 0.05
    fit = ModelFitting(stim_train,choices_train,history_bias, Tframe, args,consts,ub,lb, x_ini,z,model_f)
end
...
## SAVE THE RESULTS ##
j=1
path_save_res=path*"results/model11C2St1St2Sig_no/Rat"*rat_num*"/"
